...
7. **Multi-instance GitLab** :
   - Si une company veut importer un plugin depuis une autre instance GitLab (cross-CBA / public hub), le service account d'instance A ne peut pas lire instance B. Garder le check "same instance" ou autoriser N service accounts par company (1 par instance) ?
