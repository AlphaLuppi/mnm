...
**Date** : 2026-04-27
**Auteur** : Tom + Claude
**Cas d'usage validateur** : `https://lab.enterprise.example/example-org/hub/creation/lint-pack`
...
**Gap** : Le hub interne EnterpriseCustomer `https://lab.enterprise.example/example-org/hub/` contient déjà N plugins Claude Code prêts (skills + agents + parfois MCP/hooks) — `lint-pack`, `quality-pack`, etc. MnM n'a aujourd'hui **aucun moyen** :
...
|---|---|---|---|
| `source_url` | text | oui | URL du repo CC plugin importé (ex: `https://lab.enterprise.example/example-org/hub/creation/lint-pack`) |
