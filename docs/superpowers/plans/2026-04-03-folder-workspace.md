...
```bash
cd C:/Users/example-org/repo/perso/alphalup/mnm && bun run typecheck 2>&1 | head -50
```
...
```bash
cd C:/Users/example-org/repo/perso/alphalup/mnm && bun run typecheck 2>&1 | head -80
```
...
```bash
cd C:/Users/example-org/repo/perso/alphalup/mnm && bun run typecheck 2>&1
```
...
```bash
cd C:/Users/example-org/repo/perso/alphalup/mnm && bun run build 2>&1 | tail -20
```
...
```bash
cd C:/Users/example-org/repo/perso/alphalup/mnm && bun run dev
```
