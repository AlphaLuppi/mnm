...
- Exemple concret : "vous avez pensé au cas où l'utilisateur est un cas combinatoire, et qu.il soigne un edge case combinatoire avec plusieurs param.tres m.tier ?"
...
Un edge case combinatoire métier = connaissance tellement contextuelle et combinatoire que seule l'expérience humaine la détecte. Mais une fois formalisée, l'IA peut l'apprendre.
