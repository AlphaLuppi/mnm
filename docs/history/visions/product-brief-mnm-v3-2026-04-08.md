...
**Version :** 3.0
**Date :** 2026-04-08
**Auteur :** the contributor (cofondateur), assisté par Claude
...
Citation CEO your organization : *"Tu m'enlèves Claude Code pour me mettre un outil où j'ai pas la dernière feature de Claude Code, je suis deg et je veux pas ton outil."*
...
|----------|--------|----------|
| **Premier client en production** | your organization (équipes pluri-disciplinaires) utilise MnM quotidiennement | T3 2026 |
| **Time to First Value < 30 min** | Nouvel utilisateur productif en 30 min (Connected, defaults intelligents) | T2 2026 |
| **ARR <redacted-financials>** | 3-5 clients enterprise payants | T4 2026 |
...
- **Pour MnM** : Moat d'usage (données du flywheel propriétaires au client), network effects intra-entreprise (équipes pluri-disciplinaires → scoring calibré sur la vraie codebase)
...
|----------------|------|-----------|---------|
| **the contributor** | Cofondateur, lead technique | Haute | Architecture, vision technique, dev full-stack |
| **the lead developer** | Cofondateur, dev | Haute | Implémentation, features B2B, UX |
| **the CEO** | CEO | Haute | Vision business, relations client, stratégie |
| **CEO your organization** | Client pilote | Haute | Validation terrain, feedback sur les 3 piliers, équipes pluri-disciplinaires potentiels |
| **Équipe SRE your organization** | Partenaire technique | Moyenne | Sécurité sandbox, anti-shadow-AI, infrastructure |
...
- your organization est représentatif du marché enterprise (équipes pluri-disciplinaires, multi-rôles, compliance)
- Le pricing enterprise (<redacted-pricing>) est acceptable pour la valeur fournie
...
- your organization en production avec > 10 agents supervisés (T3 2026)
- 3 clients payants à <redacted-pricing> (T4 2026)
...
- **your organization en production**
...
| **your organization ne convertit pas en production** | Moyenne | Haute | Time to First Value < 30 min, adoption cercles concentriques, pas de big-bang |
...
2. **Network effects intra-entreprise** — équipes pluri-disciplinaires = scoring calibré sur la vraie codebase, impossible à répliquer
...
5. **Validation terrain** — CEO your organization a validé les 3 piliers. équipes pluri-disciplinaires potentiels pour le POC.
