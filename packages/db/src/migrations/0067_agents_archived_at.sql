...
-- M-FIX-1: IF NOT EXISTS makes the migration safe to re-run after a partial
-- crash mid-deploy. Drizzle's journal already prevents normal re-runs but
-- recovery scenarios (manual replay) need this guard.
