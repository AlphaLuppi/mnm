...
- **Licence commerciale / non-AGPL** : disponible pour les organisations qui ne peuvent pas adopter l'AGPL — voir [COMMERCIAL-LICENSE.md](COMMERCIAL-LICENSE.md). Contact `licensing@alphaluppi.fr`.
