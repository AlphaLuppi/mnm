...
1. Contactez `tom@alphaluppi.fr` avec une description courte de votre projet, votre stack, et le périmètre d'usage envisagé.
...
1. Contact `tom@alphaluppi.fr` with a short description of your project, your stack, and the intended scope of use.
