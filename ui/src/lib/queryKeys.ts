export const queryKeys = {
  ...
  agents: {
    ...
    detail: (companyId: string, id: string) => ["agents", companyId, "detail", id] as const,
    runtimeState: (companyId: string, id: string) => ["agents", companyId, "runtime-state", id] as const,
    taskSessions: (companyId: string, id: string) => ["agents", companyId, "task-sessions", id] as const,
    keys: (companyId: string, agentId: string) => ["agents", companyId, "keys", agentId] as const,
    configRevisions: (companyId: string, agentId: string) => ["agents", companyId, "config-revisions", agentId] as const,
  ...
  issues: {
    ...
    detail: (companyId: string, id: string) => ["issues", companyId, "detail", id] as const,
    comments: (companyId: string, issueId: string) => ["issues", companyId, "comments", issueId] as const,
    attachments: (companyId: string, issueId: string) => ["issues", companyId, "attachments", issueId] as const,
    activity: (companyId: string, issueId: string) => ["issues", companyId, "activity", issueId] as const,
    runs: (companyId: string, issueId: string) => ["issues", companyId, "runs", issueId] as const,
    approvals: (companyId: string, issueId: string) => ["issues", companyId, "approvals", issueId] as const,
    liveRuns: (companyId: string, issueId: string) => ["issues", companyId, "live-runs", issueId] as const,
    activeRun: (companyId: string, issueId: string) => ["issues", companyId, "active-run", issueId] as const,
  },
  projects: {
