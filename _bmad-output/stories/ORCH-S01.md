...
L'orchestrateur est le coeur de MnM. C'est lui qui impose que les agents IA executent EXACTEMENT ce qu'on leur dit -- des workflows deterministes, pas des suggestions. Sans lui, les agents sautent des etapes, ne chargent pas les bons fichiers, et derivent sans controle (Verite #45 votre organisation).
