...
| **Effort** | M (5 SP, 3-5j) |
| **Priorite** | P0 -- Prerequis demo your organization (chat bidirectionnel agent) |
...
C'est le "moment emotionnel de la demo" your organization : un CEO tape "Utilise le pattern Repository" dans le chat, et voit l'agent s'adapter en temps reel dans son container.
