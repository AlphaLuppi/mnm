# Brainstorming Projects v2 — Session 2 : Vision the maintainer (2026-04-06)
...
- **Ne pas créer une usine à gaz spécifique à your organization** — the maintainer est biaisé par ce modèle
...
Un projet = un produit complet. Exemple internal-product@your organization : app mobile + app web Angular + vieille app internal-backend. Un produit = ensemble de features réparties sur N codebases. Chaque codebase = un workspace avec son MCP GitNexus.

### Insight J : Prototype deployment = MVP scope (anti shadow IT)
Le déploiement de prototypes par les PM est dans le scope MVP. Raison : éviter la shadow IT — PMs qui vibecode sur Vercel/Netlify et font fuiter des infos. MnM = outil officiel pour prototyper ET déployer. L'orchestrateur + features MnM répondent aussi à l'élimination de la shadow IA. Équipe infra/SRE your organization aide sur cette partie.
