...
2. **Agnosticisme** — MnM marche pour une petite startup interne comme pour une boîte réglementée de 500 (your organization). Pas d'entités client-spécifiques. La flexibilité vient des Blocks + agents configurables.
...
- **Projet = Produit** — un projet MnM représente un produit complet (ex: "internal-product" en entreprise : mobile + web Angular + legacy internal-backend)
