...
2. **Agnosticisme** — MnM marche pour une startup de 3 (AlphaLuppi) comme pour une boîte réglementée de 500 (EnterpriseCustomer). Pas d'entités EnterpriseCustomer-spécifiques. La flexibilité vient des Blocks + agents configurables.
...
- **Projet = Produit** — un projet MnM représente un produit complet (ex: "<external-stakeholder>" chez EnterpriseCustomer : mobile + web Angular + legacy internal-backend)
