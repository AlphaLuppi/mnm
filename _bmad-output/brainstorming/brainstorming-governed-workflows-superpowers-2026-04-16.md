...
## Clarifications fondamentales (MnM founder)
...
MnM founder ne sait pas encore comment les gates custom doivent fonctionner, mais veut quelque chose d'exceptionnel.
...
─────────         ───────────       ─────────         ───────────        ─────────
MnM founder chat MnM      Tags/permissions  Trigger           Métriques          Nightly Synthesis
  │                 │                 │                 │                  │
  ▼                 │                 ▼                 ▼                  ▼
...
"teammate-A a overridé security-review sur bugfix/FEAT-001, approuvé par MnM founder, raison: hotfix prod."
...
# Company votre organisation override
workflow: bugfix
...
## Clarifications Session 2 (MnM founder)
...
MnM founder ne sait pas encore. À creuser.
...
mais du **coaching intégré dans le workflow**. Rejoint la clarification de MnM founder :
...
```
MnM founder: "Teste mon gate check-api-backward-compat sur un vrai diff"
...
MnM founder: "Teste-le sur les 10 derniers diffs du module auth"
...
→ MnM founder ajuste, re-teste, publie
```
...
## Clarifications Session 3 (MnM founder) — GAME CHANGER
...
## Clarifications Session 4 (MnM founder)
...
### Principe directeur (MnM founder)
...
## Clarifications Session 5 (MnM founder)
...
## Clarifications Session 6 (MnM founder)
...
- Gate de sortie "review OK, tout est carré" → **un autre agent** qui évalue le rapport
  (ou alternativement une step "validation" juste après, MnM founder pas sûr)
...
### Onboarding = MnM founder consulting + Sensei + CAO
Pas besoin de "bootstrap templates automatiques". MnM founder vendra du consulting.
...
MnM founder a dit "access logs qui logs TOUT" comme point 4. Ça devrait être le **fondement de l'auditabilité** :
