...
**Participants :** MnM founder (co-founder), MnM co-founder dev (dev), MnM CEO (CEO)
...
## 3. Décisions prises (MnM founder, 2026-03-20)
...
MnM founder    → role=Admin,  tags=[MnM, Bienvenue]
MnM co-founder dev    → role=Member, tags=[MnM, Bienvenue]
MnM CEO   → role=Admin,  tags=[MnM, Bienvenue]

→ Les 3 solutions marchent. Match nul. (Normal, petite équipe.)
```

### votre organisation (structure matricielle complexe)
...
Score votre organisation                    8/8          5/8          8/8
```
