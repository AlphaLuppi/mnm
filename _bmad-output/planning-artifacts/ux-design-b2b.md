...
| **Ressent** | Mefiance technique initiale. Besoin visceral de controle et de preuve. Frustration du hackathon EnterpriseCustomer — "les agents sautaient des etapes, ne chargeaient pas les bons fichiers" (Verite #45). Pression de gouvernance. |
...
6. **Exploration** (T+1min) : Le CEO clique sur l'alerte drift de la BU NA. Il voit le detail sans jargon technique : "Un agent a modifie des fichiers non-prevus. Resolu par le CTO en 2 minutes." Confiance renforcee — les problemes sont detectes ET resolus.
...
**Verdict Phase 1 :** 4 Quick Wins sur 6 experiences. C'est la phase la plus rentable en ratio impact/effort. Le time-to-value pour EnterpriseCustomer (SC-BIZ-5 : <2h) dépend directement de la fluidité de ces écrans.
...
**Verdict Phase 2 :** La matrice de permissions est l'experience la plus stratégique. C'est le moment "wow" pour le CTO de EnterpriseCustomer — il voit en un coup d'oeil qui peut faire quoi. Impact direct sur SC-D4 (100% validation humaine) et SC-BIZ-1 (POC signé).
...
**Verdict Phase 3 :** Le scoping par projet est le pivot vers le vrai multi-tenant. C'est ce qui rend MnM vendable au-delà de EnterpriseCustomer. L'experience "page d'accès par projet" est stratégique car elle active SC-C4 (companies avec 3+ niveaux hiérarchiques).
...
| **Strategic** | 11 | Phases 2-4 | Planifier avec wireframes detaillés, valider avec EnterpriseCustomer |
| **Nice-to-have** | 5 | Toutes phases | Intégrer si sprint le permet |
| **Defer** | 1 | Phase 4 | Reporter post-MVP (dashboards PO/PM) |

**Conclusion priorisation :** Les Quick Wins des Phases 1-2 représentent le socle minimum pour le POC EnterpriseCustomer (SC-BIZ-1). Les 11 experiences Strategic sont le coeur du produit vendable. Le ratio Quick Wins/Strategic (8/11) confirme que le scope est ambitieux mais réaliste sur 8-10 semaines.
...
**Objectif :** Permettre au CEO EnterpriseCustomer d'inviter son équipe et de voir les membres.
...
**Critère de succès Phase 1 :** Le CEO EnterpriseCustomer peut inviter 5 personnes par email, voir la liste des membres, et les invités peuvent se connecter et accéder à l'app.

### 4.2 Phase 2 — Écrans RBAC (Semaines 2-3)

**Objectif :** Le CTO EnterpriseCustomer peut attribuer des rôles et voir la matrice de permissions.
...
**Critère de succès Phase 4 :** Le CEO EnterpriseCustomer ouvre son dashboard et comprend l'état de son organisation en <30 secondes. Le CTO configure SSO en <15 minutes. L'audit log montre toutes les actions des 3 derniers mois.
...
### Priorité absolue (POC EnterpriseCustomer, Semaines 1-3)
1. **Quick Wins Phase 1** — Page Membres + Invitations + Auth = le minimum pour que EnterpriseCustomer puisse utiliser MnM avec 5+ personnes
...
- **Time-to-first-value EnterpriseCustomer** : CEO fonctionnel en <48h, CTO en <4h, Dev en <30 min
...
- Le perimetre pre-configure ("Vous etes CTO de la BU EU, 3 equipes, 12 devs")
