...
{
  "protocol": "oidc",
  "displayName": "votre organisation SSO",
...
5. Onboarder la première company externe (votre organisation) en parallèle de la Legacy Company

**Progressive rollout** :
```
Semaine 1 : Legacy Company uniquement (feature flag off)
Semaine 2 : votre organisation ajouté (feature flag on pour votre organisation seulement)
...
**Validation Phase 4** :
- votre organisation onboardé avec 10+ utilisateurs sur 3+ rôles RBAC
- Isolation vérifiée : votre organisation ne voit pas les données Legacy, et vice versa
...
- Fin Phase 4 : votre organisation onboardé + 1 semaine sans incident → déclaration multi-tenant stable
