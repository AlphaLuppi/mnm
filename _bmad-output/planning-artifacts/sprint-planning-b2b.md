...
> **Deadline critique** : Démo EnterpriseCustomer — Juin 2026
...
14. [Critères de Succès Démo EnterpriseCustomer](#14-critères-de-succès-démo-cba)
...
**Total : 13 semaines calendaires | 197 SP planifiés (scénario MVP EnterpriseCustomer)**
...
| **S9** | Containerisation + Chat bidirectionnel | **Milestone MVP EnterpriseCustomer rugueux** |
| **S11** | A2A + Dual-Speed + Compaction | Feature complete |
| **S13** | Enterprise + Polish + Démo EnterpriseCustomer | **🎯 DÉMO EnterpriseCustomer** |
...
### **🎯 Milestone MVP EnterpriseCustomer Rugueux (Fin Sprint 5, ~S11)**
...
**Objectif** : SSO, dashboards, import Jira, stabilisation, préparation démo EnterpriseCustomer
...
- Données de démo EnterpriseCustomer (agents, workflows, projets)
- Script de démo et répétition
- Tests E2E smoke complets (7 tests)
- Performance testing (k6 baseline)

### **🎯 DÉMO EnterpriseCustomer (Fin Sprint 6, ~S13 = Juin 2026)**
...
|----------|-----------|---------|-------|
| **MVP EnterpriseCustomer strict** | 28 SP/sprint | 7 (S0+S6) | **13 semaines** |
| Réaliste complet | 26 SP/sprint | 10-11 | 20-22 semaines |
| Pessimiste | 20 SP/sprint | 13-15 | 26-30 semaines |

### 9.4 Ce qui est reporté au Post-MVP pour le Scénario EnterpriseCustomer
...
**Résultat** : MVP EnterpriseCustomer = ~200-250 SP → 7 sprints à 28-32 SP → **13-14 semaines faisable**.
...
| **R5** | Docker indisponible chez EnterpriseCustomer | Faible | ÉLEVÉ | Vérifier infra S0. Plan B: processus isolés | S0 |
...
## 14. Critères de Succès Démo EnterpriseCustomer (John)

### 14.1 Les 8 Points de la Démo

Pour que la démo EnterpriseCustomer soit un succès menant à un POC signé :

- [ ] **Le CTO EnterpriseCustomer peut inviter 3-5 membres** avec des rôles différents
...
- [ ] **Le dev EnterpriseCustomer dialogue en temps réel** avec son agent
...
| Critère | Cible Démo EnterpriseCustomer | Epic |
|---------|---------------|------|
...
[INFRA][MU+RBAC ][RBAC+ORCH][ORCH+OBS][CONT+CHAT][A2A+DUAL ][ENT+DEMO]
                                                    ↑              ↑
                                              MVP RUGUEUX    🎯 DÉMO EnterpriseCustomer
```

**Si les 8 points sont couverts, le POC EnterpriseCustomer est gagné.**

---

*Sprint Planning B2B v1.0 — ~4500 mots — 7 sprints, 197 SP planifiés (MVP EnterpriseCustomer), timeline 13 semaines.*
