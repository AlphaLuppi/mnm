...
- Given un plafond hierarchique a "Assiste" When l'utilisateur voit le curseur Then la position "Auto" est grisee avec un tooltip "Limite par your organization"
