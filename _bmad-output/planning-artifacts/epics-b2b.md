...
| **B** | Observabilité & Audit | **MnM founder** | OBS, DASH |
| **C** | Onboarding Cascade | **MnM founder** | ONB |
...
**Assignation** : Partagé MnM founder + Cofondateur
...
**Assignation** : MnM founder (backend) + Cofondateur (frontend)
...
**Description** : Middleware `requirePermission(key, scopeExtractor?)` sur toutes les routes. 3 fichiers critiques sans aucun check : approvals.ts, assets.ts, secrets.ts. **Splitting recommandé** : MnM founder = routes critiques, Cofondateur = reste.
**Assignation** : MnM founder + Cofondateur
**Effort** : L (8 SP, 5-7j)
...
**Assignation** : MnM founder | **Effort** : S (2 SP, 1j) | **Bloqué par** : TECH-06

### Story PROJ-S02 : Service project-memberships.ts
**Assignation** : MnM founder | **Effort** : M (3 SP, 2-3j) | **Bloqué par** : RBAC-S01
...
**Assignation** : MnM founder | **Effort** : M (5 SP, 3-5j) | **Bloqué par** : PROJ-S02
...
**Effort** : M (5 SP, 3-5j)
**Bloqué par** : ORCH-S01
**Note** : P1 — éditeur YAML suffit pour le MVP votre organisation.
...
**Assignation** : MnM founder | **Effort** : M (3 SP, 2-3j)
...
**Assignation** : MnM founder | **Effort** : M (5 SP, 3-5j) | **Bloqué par** : ORCH-S01
...
**Assignation** : MnM founder | **Effort** : M (5 SP, 3-4j) | **Bloqué par** : TECH-05
...
**Assignation** : MnM founder | **Effort** : M (5 SP, 3-5j) | **Bloqué par** : RBAC-S04
...
**Assignation** : MnM founder | **Effort** : M (3 SP) | P1

### Story ONB-S02 : Cascade Hiérarchique
**Assignation** : MnM founder | **Effort** : S (2 SP) | P1

### Story ONB-S03 : Import Jira Intelligent
**Assignation** : MnM founder | **Effort** : M (5 SP) | P2
...
**Assignation** : MnM founder | **Effort** : L (8 SP, 5-7j) | **Bloqué par** : TECH-04
...
**Assignation** : MnM founder | **Effort** : M (5 SP, 3-5j) | **Bloqué par** : CONT-S01 (dépendance forte)
...
**Priorisation** : P1 — Reportable post-démo votre organisation

### Story SSO-S01 : Table sso_configurations + Config
**Assignation** : MnM founder | **Effort** : S (2 SP, 1j)
...
|------------|--------|--------|---------------------|
| **MnM founder** | B (Obs) + C (Onb) + Infra | ~115-140 SP | TECH-01 à 07, RBAC backend, OBS, WebSocket, Chat backend, SSO backend, API routes |
...
| Fin S8 | Containerisation + Chat | Go/No-Go Démo votre organisation |
...
| Durée MVP votre organisation (strict) | 12-13 semaines (Sprint 0-5) |
