...
| **Team** | Équipe 5-50 | ~<redacted-pricing>/user/mois | Multi-users, RBAC, scoping projet, import, chat, containerisation. |
| **Enterprise** | 100+ users | ~<redacted-pricing>/user/mois | SSO, audit complet, drift avancée, multi-tenant, SLA + CSM. |
