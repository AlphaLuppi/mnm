...
> **Contexte** : Sprint planning pour la transformation B2B de MnM — Deadline critique : **Démo EnterpriseCustomer en juin 2026**
...
La matrice ci-dessous évalue chaque epic selon deux axes : l'**impact business** (valeur pour la démo EnterpriseCustomer et pour la conversion en client payant) et l'**effort de développement** (en semaines-développeur).
...
5. **Scoping par Projet** (Strategique, 2-3 sem) -- Isolation fine, necessaire pour EnterpriseCustomer multi-projets
6. **Observabilite & Audit** (Strategique, 2-3 sem) -- Dashboard pour la demo EnterpriseCustomer
