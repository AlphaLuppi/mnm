...
- Un User peut être membre de plusieurs Companies (ex: BU EU + Projet Transverse)
...
| Un nouveau concurrent apparaît | Haute | Le marché est jeune. Mitigation : vitesse d'exécution, EnterpriseCustomer comme design partner, communauté open source. |
