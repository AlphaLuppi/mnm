...
- **Niko** — Besoin de compréhension et d'édition visuelle des workflows
...
### Journey 3 : Niko — Comprendre et éditer un workflow
...
| **Visual → Edit → Save** | Voir → modifier → sauvegarder vers fichier source | Niko |
...
- Test keyboard-only : navigation complète sans souris sur tous les parcours critiques (Tom, Gabri, Niko)
