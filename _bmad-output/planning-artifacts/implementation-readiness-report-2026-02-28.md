...
- 3 user journeys détaillées (Tom, Gabri, Niko) qui couvrent les cas d'usage principaux
...
| User Journeys | Tom, Gabri, Niko | 3 flows détaillés correspondant aux 3 journeys PRD | Aligné |
