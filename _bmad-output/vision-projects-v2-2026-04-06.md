...
**Date:** 2026-04-06
**Auteur de la vision:** MnM founder (co-fondateur Studio Manifeste)
...
2. **Agnosticité** — Doit marcher pour Studio Manifeste (petite équipe, startup) comme pour votre organisation (enterprise réglementé). Zéro logique métier hardcodée.
...
- **Projet = Produit** — un projet MnM représente un produit complet (ex: "legacy-app" en entreprise)
- **Multi-codebase** — un produit peut avoir N codebases/workspaces (app mobile, web Angular, vieille app legacy-backend...). Chaque codebase a son MCP GitNexus.
...
└── Node "REQ: MFA obligatoire"         [type: requirement, project_id: null] ← company-wide
    ├── entity_link → Node "Authentification" projet legacy-app
...
- **Enterprise réglementé (votre organisation)** : features structurées avec requirements numérotés, liens vers cahiers des charges, couverture de tests par requirement. La même Feature Map montre une matrice de conformité.
...
*Vision documentée le 2026-04-06 — Session brainstorm MnM founder + Claude*
