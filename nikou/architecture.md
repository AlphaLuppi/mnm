...
**Pourquoi abandonné:** Résultat = 2 fenêtres séparées, UX fragmentée, 2 renderers différents à maintenir, IPC bridge complexe entre React et GPUI. Contraire à la contrainte Niko.
