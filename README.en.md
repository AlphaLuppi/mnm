...
- **Commercial / non-AGPL license**: available for organizations that cannot adopt AGPL — see [COMMERCIAL-LICENSE.md](COMMERCIAL-LICENSE.md). Contact `tom@alphaluppi.fr`.
