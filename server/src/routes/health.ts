...
export function healthRoutes(
  ...
  opts: {
     ...
     * "0.1.0". When set, the /api/health response advertises it so
     * desktop builds below this version can surface a non-blocking
     * update banner. `null` or unset means no minimum is enforced.
     */
